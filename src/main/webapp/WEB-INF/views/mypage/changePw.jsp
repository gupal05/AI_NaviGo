...
<div class="mypage-container container">
    ...
    <div class="resetpw-container">
        <div class="resetpw-header">
            <h1 class="resetpw-title">비밀번호 변경</h1>
        </div>
        ...
        <form action="/auth/login" method="get" id="change-password-form">
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="current_password" name="memberPw" placeholder="현재 비밀번호를 입력하세요">
            </div>
    ...
    $(document).ready(function() {
        $("#change-password-btn").click(function() {
            ...
            if (newPassword.val() !== confirmPassword.val()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/mypage/updatechangePw",
                    data: {
                        currentPw: current.val(),
